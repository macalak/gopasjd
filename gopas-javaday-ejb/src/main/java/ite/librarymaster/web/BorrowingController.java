...
import ite.librarymaster.service.BorrowingServiceLocal;
...
@javax.faces.bean.ManagedBean(name="borrowingController")
...
public class BorrowingController implements Serializable{
	...
	@EJB
	private BorrowingServiceLocal borrowingService;
